...
unsigned int nStakeMinAge = 60 * 60 * 4; // 4 hour
...
const string strMessageMagic = "SkeletonCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 1)
    {
        ...
        else if(pindexBest->nHeight < 800002)
    {
        nSubsidy = 50 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 800002)
    {
        nSubsidy = 50 * COIN; 
    }
    else if(pindexBest->nHeight > 800001)
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SkeletonCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "02/10/2016: Kim Dotcom Reiterates His Bitcoin Price Forecast, $2000 in 2 Years";
        CTransaction txNew;
        txNew.nTime = 1475399548;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1475399548;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1769333;

        

        assert(block.hashMerkleRoot == uint256("0xfb79130f95b10d32b0e5be832209e00e2d3b9b67f569ce0aa0c500ec89439ec5"));
    ...
    string strPubKey = "046b0cabe12fd41e98c892ca51110a220d735818dfcb601a7bfe088f5a5a332ab1aa2630f31fda4e5f94ff4de36805cf16d9d9100cc9d2fb1a64d760aac8f70de2";
